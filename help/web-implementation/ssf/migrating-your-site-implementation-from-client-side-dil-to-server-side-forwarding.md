...
Pour plus d’informations sur [!UICONTROL Server-Side Forwarding], consultez la [documentation](https://experienceleague.adobe.com/docs/analytics/admin/admin-tools/server-side-forwarding/ssf.html).
