...
+ Créer et gérer des audiences {#build-and-manage-audiences}
   + Explorateur de données {#data-explorer}
      ...
      + [Utilisez Data Explorer pour rechercher des paires clé/valeur utilisées et inutilisées.](build-and-manage-audiences/data-explorer/using-data-explorer-to-search-for-used-and-unused-key-value-pairs.md)
      ...
      + [Utiliser Data Explorer pour valider la création de caractéristiques pour les données intégrées](build-and-manage-audiences/data-explorer/using-data-explorer-to-validate-trait-creation-for-your-onboarded-data.md)
   ...
   + Caractéristiques et segments {#traits-and-segments}
      ...
      + [Création d’une taxonomie des caractéristiques](build-and-manage-audiences/traits-and-segments/creating-a-trait-taxonomy.md)
      ...
      + [Créer et gérer des caractéristiques en bloc avec BAAAM](build-and-manage-audiences/traits-and-segments/creating-and-managing-traits-in-bulk-with-baaam.md)
      ...
      + [Création d’une taxonomie des segments](build-and-manage-audiences/traits-and-segments/creating-a-segment-taxonomy.md)
      ...
      + [Amélioration des segments avec des recommandations de caractéristiques](build-and-manage-audiences/traits-and-segments/enhancing-your-segments-with-trait-recommendations.md)
   ...
   + Modèles algorithmiques {#algorithmic-models}
      ...
      + [Utilisation de modèles semblables pour étendre l’inventaire épuisé à partir de vos données propriétaires](build-and-manage-audiences/algorithmic-models/using-look-alike-models-to-extend-sold-out-inventory-from-your-1st-party-data.md)
   + Fusion de profil {#profile-merge}
      ...
      + [Choisir la règle de fusion de profils appropriée](build-and-manage-audiences/profile-merge/choosing-the-right-profile-merge-rule.md)
      ...
      + [Utilisation de stratégies de fusion de profils pour personnaliser un état authentifié](build-and-manage-audiences/profile-merge/using-profile-merge-rules-to-personalize-in-an-authenticated-state.md)
      + [Utilisation de stratégies de fusion de profils pour l’extension d’appareil et une portée accrue](build-and-manage-audiences/profile-merge/using-profile-merge-rules-for-device-extension-and-increased-reach.md)
      ...
      + [Conseils aux clients - tirer le meilleur parti des stratégies de fusion de profils](build-and-manage-audiences/profile-merge/customer-tips-getting-the-most-out-of-profile-merge-rules.md)
+ Activation des données {#data-activation}
   + Concepts de base des destinations {#destinations-basics}
      + [Présentation des types de destination d’Audience Manager](data-activation/destinations-basics/understanding-audience-manager-destination-types.md)
   ...
   + Destinations basées sur les personnes {#people-based-destinations}
      ...
      + [Comprendre et configurer la destination basée sur les personnes qui correspond aux clients Google](data-activation/people-based-destinations/understanding-and-configuring-the-google-customer-match-pbd.md)
+ Rapports {#reports}
   ...
   + [Présentation des audiences associées avec les rapports de chevauchement](reports/understand-related-audiences-with-overlap-reports.md)
   + [Utiliser des rapports d’Audience Optimization pour comprendre les performances multimédia](reports/using-audience-optimization-reports-to-understand-media-performance.md)
+ Autres intégrations {#other-integrations}
   + Intégration à Real-time Customer Data Platform {#integrating-with-rtcdp}
      ...
      + [Présentation des caractéristiques de la plateforme de données clients en temps réel](other-integrations/integrating-with-rtcdp/rtcdp-traits-for-aam-users.md)
      ...
      + [Comprendre le contrôle d’accès dans la plateforme de données clients en temps réel](other-integrations/integrating-with-rtcdp/rtcdp-access-control-for-aam-users.md)
