...
+ Nouvelles et tendances du secteur {#industry}
   + [L&#39;avenir du Data Management et l&#39;Environnement changeant](industry/the-future-of-data-management-and-the-changing-environment.md)
   + [10 points à prendre en compte pour un Data Management client responsable](industry/ten-considerations-for-responsible-customer-data-management.md)
   + [Un tableau de deux perceptions - Marques contre Consommateurs](industry/brands-vs-consumers.md)
...
+ Audience Marketplace {#audience-marketplace}
   ...
   + Vente de données {#selling-data}
      + [Commercialiser les audiences détenues sur le marché](audience-marketplace/selling-data/commercialize-owned-audiences-on-marketplace.md)
...
+ Autres intégrations {#other-integrations}
   + Intégration à la plateforme de données client en temps réel {#integrating-with-rtcdp}
      ...
      + [Présentation de l&#39;importation de données propriétaires dans le CDP en temps réel](other-integrations/integrating-with-rtcdp/rtcdp-1pd-ingestion-for-aam-users.md)
      + [Présentation de l&#39;importation des données Web dans le CDP en temps réel](other-integrations/integrating-with-rtcdp/rtcdp-web-ingestion-for-aam-users.md)
      + [Présentation des Schémas et de la gestion des contenus dans le CDP en temps réel](other-integrations/integrating-with-rtcdp/rtcdp-schemas-xdm-for-aam-users.md)
      + [Comprendre les caractéristiques du CDP en temps réel](other-integrations/integrating-with-rtcdp/rtcdp-traits-for-aam-users.md)
      + [Présentation des signaux dans le CDP en temps réel](other-integrations/integrating-with-rtcdp/rtcdp-signals-for-aam-users.md)
      + [Présentation des segments dans le CDP en temps réel](other-integrations/integrating-with-rtcdp/rtcdp-segments-for-aam-users.md)
      + [Présentation des destinations dans le CDP en temps réel](other-integrations/integrating-with-rtcdp/rtcdp-destinations-for-aam-users.md)
      + [Comprendre le Contrôle d&#39;accès dans le CDP en temps réel](other-integrations/integrating-with-rtcdp/rtcdp-access-control-for-aam-users.md)
      + [Comprendre la gouvernance des données dans le CDP en temps réel](other-integrations/integrating-with-rtcdp/rtcdp-data-gov-for-aam-users.md)
...
+ Visiteur{#api}
   + [Récupérer les informations d&#39;identification de l&#39;API dans l&#39;Adobe I/O](api/retrieve-api-credentials-in-adobe-io.md)
